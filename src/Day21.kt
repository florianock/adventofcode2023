fun main() { // --- Day 21: Step Counter ---
    ...
    check(part1(testInput2, 1) == 4)
    check(part1(testInput2, 2) == 7)
    check(part1(testInput2, 3) == 15)
    check(part1(testInput2, 6) == 32)
    check(part2(testInput2, 6) == 36L)
    check(part2(testInput2, 10) == 90L)
    check(part2(testInput2, 50) == 1_940L)
    check(part2(testInput2, 100) == 7_645L)
    check(part2(testInput2, 500) == 188_756L)
    check(part2(testInput2, 1_000) == 753_480L)
